    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Specialty
                </th>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Department
                </th>
            ...
            <c:forEach items="${doctors}" var="doctor">
                <tr class="hover:bg-gray-750 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                        <c:choose>
                            <c:when test="${not empty doctor.roomNumber}">${doctor.roomNumber}</c:when>
                            <c:otherwise>
                                No room attached
                            </c:otherwise>
                        </c:choose>
